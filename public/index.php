  ...
  <div class="flex min-w-0 flex-1 flex-col">
    <header class="flex h-16 shrink-0 items-center gap-3 border-b border-slate-200 bg-white px-4 sm:px-6">
      ...
      <div class="ml-auto flex items-center gap-3">
        <div id="wa-bell-wrap" class="relative hidden">
          <button id="wa-bell-btn" type="button" aria-label="Notificaciones de WhatsApp"
            ...
            <span id="wa-bell-badge" class="absolute right-1 top-1 hidden h-4 min-w-4 items-center justify-center rounded-full bg-red-600 px-1 text-[10px] font-bold text-white"></span>
          </button>
          <div id="wa-bell-panel" class="absolute right-0 top-full z-50 mt-2 hidden w-80 rounded-xl bg-white p-2 shadow-lg ring-1 ring-slate-200"></div>
        </div>
